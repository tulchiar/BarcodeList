...
public class WarehouseTest {
	...
	public static void main(String[] args) {
		...
		try {
			...
			Box box = BoxFactory.create(BoxType.type1, "Barcode__123456", "Bronx");
			warehouse.addBox(box);
			
			System.out.println("Box nr : " + ++x + " --- " + box);

			box = BoxFactory.create(BoxType.type1, "Barcode__222222", "Bronx");
			warehouse.addBox(box);
			
			System.out.println("Box nr : " + ++x + " --- " + box);
			
			box = BoxFactory.create(BoxType.type1, "Barcode__333333", "Sanquian");
			warehouse.addBox(box);
			
			System.out.println("Box nr : " + ++x + " --- " + box);
			
			box = BoxFactory.create(BoxType.type1, "Barcode_444444", "Bronx");
			warehouse.addBox(box);
